...
def parse_genre(genre, stations, url=None, func=None, s_term='sgenre'):
    ...
    """
    if url == None:
        url = "http://classic.shoutcast.com/directory/" \
    ...
    for station in tup:
        ...
        station = new
        s = dict()
        s['loc'] = "http://classic.shoutcast.com%s" % station[0]
        s['album'] = station[1]
        s['album'] = station[1]
        s['title'] = station[2]
        s['bitrate'] = station[4]
    ...
    if m != None:
        ...
        parse_genre(genre, stations,
            "http://classic.shoutcast.com/directory/index.phtml" \
...
class ShoutcastDriver(radio.RadioDriver):
    ...
    def load_streams(self, node, load_node, use_cache=True):
        ...
        if use_cache and os.path.isfile(cache_file):
            ...
            data = urllib.urlopen('http://classic.shoutcast.com').read()
